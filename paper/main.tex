...
(DINO-WM) on Wall navigation but $0/6\approx0/6$ on PushT contact, a
direction that replicates across both world-model families --- a
two-endpoint contrast at $N{=}6$ episodes per cell, not a cross-env law.
\end{abstract}
